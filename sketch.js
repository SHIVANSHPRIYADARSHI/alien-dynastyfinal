...
function preload() {
    ...
    level2img = loadImage("bg2.jpeg")
    level3img = loadImage("level3.jpg")

    platform1img = loadImage("platform.png")
    platform2img = loadImage("platform_2.png")
    enemy1img = loadImage("enemy1-unscreen.gif")
    enemy2img = loadImage("enemy2-unscreen.gif")
    enemy3img = loadImage("enemy3-unscreen.gif")
    enemy4img = loadImage("enemy4-unscreen.gif")
    enemy5img = loadImage("enemy-5-unscreen.gif")
...
function setup() {
    ...
    coin3 = createSprite(platform2.x - 20, platform2.y - (platform2.height + 15))
    coin3.addAnimation("coin1", coinimg)
    coin3.scale = 0.15
    coin3.visible = false

    coin4 = createSprite(platform3.x - 20, platform3.y - (platform3.height + 12))
    coin4.addAnimation("coin2", coinimg)
    coin4.scale = 0.15
    coin4.visible = false


    coin5 = createSprite(platform4.x - 20, platform4.y - (platform4.height + 15))
    coin5.addAnimation("coin3", coinimg)
    coin5.scale = 0.15
    coin5.visible = false
    ...
    coin6 = createSprite(platform2.x - 20, platform2.y - (platform2.height + 15))
    coin6.addAnimation("coin1", coinimg)
    coin6.scale = 0.15
    coin6.visible = false

    coin7 = createSprite(platform3.x - 20, platform3.y - (platform3.height + 12))
    coin7.addAnimation("coin2", coinimg)
    coin7.scale = 0.15
    coin7.visible = false


    coin8 = createSprite(platform4.x - 20, platform4.y - (platform4.height + 15))
    coin8.addAnimation("coin3", coinimg)
    coin8.scale = 0.15
    coin8.visible = false
